...
if you don't want losed your classes in object add an attribute serializationName to the object or on his prototype ( that is a string with the class name). constructor have to be public.
